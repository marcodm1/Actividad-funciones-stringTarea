...
<!-- 
           ...
           // strlen(cadena) Devuelve la longitud (nº de caracteres) de la cadena.
           // Los espacios se consideran como un carácter más.
           // echo strlen('mide la longitud') ;
           // 16
           // strtolower(cadena) Devuelve la cadena con todos los caracteres en
           // minúsculas
           // echo strtolower('MaRiA') ;
           // maria
           // strtoupper(cadena) Devuelve la cadena con todos los caracteres en
           // mayúsculas
           // echo strtoupper('MaRiA') ;
           // MARIA
           // ucwords(cadena) Devuelve la cadena con el primer carácter de cada
           // palabra en mayúsculas
           // echo ucwords('hola y aDIOS') ;
           // Hola Y ADIOS
           // ucfirst(cadena) Devuelve la cadena con el primer carácter en
           // mayúsculas
           // echo ucfirst('hola y aDIOS') ;
           // Hola y aDIOS
           // chr(n) Devuelve el carácter cuyo código ASCII es n.
           // echo chr(97) ;
           // a
           // ord(cadena) Devuelve código ASCII del primer carácter de la
           // cadena.
           // echo ord('abadesa') ;
           // 97
